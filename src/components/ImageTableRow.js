...
const ImageTableRow = (props) => {
    ...
    const { image, handleCheckButtonChange, num } = props;
    ...
    return (
        <tr class="transition-all hover:bg-gray-200 hover:shadow-lg">
            <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                    <div class="flex flex-col items-center">
                        <input type="checkbox" onChange={() => handleCheckButtonChange(image.objectId + num)}></input>
                    </div>
                    <div class="ml-4">
            ...
            <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">{image.timestamp}</td>
